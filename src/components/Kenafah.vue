<template>
  ...
  >
    ...
    >
      ...
      <p class="text-3xl font-title font-bold">
        Kenapa Kami Tidak Memberikan Insight Apapun ?
      </p>
      <p class="font-title text-base py-8">
      ...
      <button
        ...
        "
      >
        Pelajari Lebih Lanjut <img src="/arrow.png" class="ml-3" />
      </button>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:mt-0 mt-28">
      <div
        ...
        data-aos-duration="1500"
        class="w-[290px] bg-[#0D0E25] text-white rounded-lg p-9"
      >
      ...
      <div
        ...
        data-aos-duration="1500"
        data-aos-anchor-placement="top-center"
        class="w-[290px] border-t border-l p-9"
      >
        <div class="flex items-center">
