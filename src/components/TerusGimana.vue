<template>
  <div class="mb-40">
    <div
      ...
      class="md:w-[658px] mb-5 mx-auto"
    >
      <p class="text-center text-[#FC881D] font-title font-semibold">
        TERUS GIMANA?
      </p>
    ...
    <div class="flex flex-wrap justify-evenly container mx-auto mt-20">
      <div
        ...
        data-aos-duration="2000"
        class="w-[93vw] md:w-[380px] xl:mt-0 mt-7"
      >
        <div class="bg-gray-200 rounded-xl">
          <img src="/lope.png" class="mx-auto py-14" />
        </div>
        <p class="font-title font-semibold text-xl py-4">
