      ...
      >
        ...
        >
          <div
            ...
            class="w-[580px] md:px-0 px-3"
          >
            <div class="flex items-center">
              <div class="border border-white w-[45px]"></div>
              <p class="font-title font-semibold text-base ml-4">
                ALTERNATIVES
              </p>
            </div>
        ...
        >
          <div
            ...
            class="w-[250px] md:w-[300px] xl:w-[500px] md:mr-3 relative"
          >
          ...
          <div
            ...
            data-aos-easing="linear"
            data-aos-duration="2000"
            class="w-[250px] md:w-[300px] xl:w-[500px] md:ml-3 mt-7 lg:mt-0"
          >
